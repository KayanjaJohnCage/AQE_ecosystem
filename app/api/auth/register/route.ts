...
import { createProfileRecord, persistProfileRecord } from '../../../../lib/aqe/profile'
...
export async function POST(request: Request) {
  try {
    ...
    if (!email || !password) {
      return NextResponse.json({ ok: false, reason: 'Email and password are required.' }, { status: 400 })
    }
