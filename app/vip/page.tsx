...
export default function VipPage() {
  ...
  return (
    <main style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p>VIP withdrawals are available only on the configured three-day weekly schedule.</p>

      <section style={{ background: '#101827', borderRadius: 12, padding: 20, marginTop: 20 }}>
        <h2>Current schedule</h2>
        <p>Mon, Wed, Fri</p>
        <button onClick={handleRequest} disabled={loading}>{loading ? 'Checking...' : 'Request withdrawal'}</button>
      </section>
