    ...
    <div className="manager-root">
      ...
      <main className="manager-main">
        ...
        <section className="manager-content">
          <p>
            Internal manager console. User support tickets belong in the public{" "}
            <strong>Manager Support Room</strong>, while internal reporting and
            operational controls remain here.
          </p>
