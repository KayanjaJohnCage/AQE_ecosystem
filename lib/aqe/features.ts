...
export const VIP_FEATURES: FeatureKey[] = ['invites', 'my_team', 'rewards', 'raffle', 'asset_room', 'store']

export function isFeatureAvailableForTier(feature: FeatureKey, tier: 'basic' | 'premium' | 'vip'): boolean {
...
export function getUpgradePath(tier: 'basic' | 'premium' | 'vip') {
  ...
  if (tier === 'premium') return 'Upgrade to VIP for invite, team, raffle, and asset room access.'
